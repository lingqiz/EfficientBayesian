function paras = expectedBias(average, spread, range, showPlot, lineColor)
...
if showPlot
    hold on; grid on;
    plot(range, average, 'LineWidth', 2, 'Color', lineColor);
    plot(range, predBias(paras(1), paras(2)), '--', 'LineWidth', 2, 'Color', zeros(1, 3));
